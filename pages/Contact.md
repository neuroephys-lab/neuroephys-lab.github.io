...
<div class="row" style="padding-top: 60px; margin-top: -60px;">
    <div class="col-sm-4">
    	<img src="/img/publications/SOMstressNatCom.png.jpg" alt="FMUP" width="100%" height="100%">
    </div>
    <div class="col-sm-8">
...
<div class="row" style="padding-top: 60px; margin-top: -60px;">
    <div class="col-sm-6">
    	<iframe src="https://goo.gl/maps/7w2mLytRq9jZhdQx5" width="100%" height="400" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
    </div>
</div>
